      ...
      {auditData && (
        <>
          ...
          <ResponsiveContainer width="100%" height={240}>
            <BarChart data={[
              { group: "White", rate: auditData?.white_approval_rate || 0 },
              { group: "Black", rate: auditData?.black_approval_rate || 0 },
              { group: "Hispanic", rate: auditData?.hispanic_approval_rate || 0 },
            ]}>
              <XAxis dataKey="group" />
